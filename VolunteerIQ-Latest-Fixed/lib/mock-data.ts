...
export const mockActivityLog: ActivityLog[] = [
  ...
  },
  {
    ...
    needId: 'n-001',
    action: 'assigned',
    description: '**Sneha Kulkarni** (Logistics) matched and notified',
  ...
  },
  {
    ...
    needId: 'n-001',
    action: 'assigned',
    description: '**Sanjay Gaikwad** (Cooking) joined the distribution team',
  ...
  },
  {
    ...
    needId: 'n-001',
    action: 'updated',
    description: 'First shipment of water filters arrived at Parbhani hub',
  ...
  },
  {
    ...
    needId: 'n-002',
    action: 'created',
    description: 'Medical emergency reported from **Osmanabad District Hospital**',
  ...
  },
  {
    ...
    needId: 'n-002',
    action: 'assigned',
    description: '**Dr. Ankit Patil** dispatched with medical supplies',
  ...
  },
  {
    ...
    needId: 'n-002',
    action: 'updated',
    description: 'AI detected high urgency based on "critical supplies" keyword',
  ...
  },
  {
    ...
    needId: 'n-002',
    action: 'assigned',
    description: '**Rohit Shinde** (Driving) assigned for transportation',
  ...
  },
  {
    ...
    needId: 'n-002',
    action: 'updated',
    description: 'Blood units requested for O+ and A- patients',
  ...
  },
  {
    ...
    needId: 'n-001',
    action: 'updated',
    description: 'Local volunteer coordinator **Anjali Pawar** joined the thread',
  ...
  },
  {
    ...
    needId: 'n-001',
    action: 'updated',
    description: 'Cargo truck #MH20-4412 dispatched with food packets',
  ...
  },
  {
    ...
    needId: 'n-001',
    action: 'updated',
    description: 'Distribution point established at **Nandgaon Primary School**',
  ...
  },
  {
    ...
    needId: 'n-001',
    action: 'updated',
    description: '30/34 families received initial relief kits',
  ...
  },
  {
    ...
    needId: 'n-001',
    action: 'updated',
    description: 'Field report: Road conditions improved, SUVs no longer needed',
  ...
  },
  {
    ...
    needId: 'n-002',
    action: 'updated',
    description: 'District Collector notified of supply shortage',
  ...
  },
  {
    ...
    needId: 'n-002',
    action: 'updated',
    description: 'Medical team confirmed arrival of oxygen concentrators',
  ...
  },
  {
    ...
    needId: 'n-002',
    action: 'updated',
    description: 'Hospital staff training scheduled for new equipment',
    timestamp: new Date(Date.now() - 30 * 60 * 1000),
  },
  {
    id: 'a-020',
    needId: 'n-002',
    action: 'updated',
    description: 'Volunteer **Vikram Jadhav** assisting with heavy lift moving',
    timestamp: new Date(Date.now() - 15 * 60 * 1000),
  },
  {
    id: 'a-021',
    needId: 'n-002',
    action: 'updated',
    description: 'Case file updated: 4 critical patients stabilized',
  ...
  },
  {
    ...
    needId: 'n-003',
    action: 'created',
    description: 'Relief request for **Chandrapur** created via coordination portal',
  ...
  },
  {
    ...
    needId: 'n-003',
    action: 'updated',
    description: 'Initial assessment: 156 families need urgent dry rations',
  ...
  },
  {
    ...
    needId: 'n-003',
    action: 'assigned',
    description: '**Nilesh Raut** assigned to transport supplies from Nagpur',
  ...
  },
  {
    ...
    needId: 'n-003',
    action: 'updated',
    description: 'Distribution partner **SaveLife NGO** confirmed for last-mile',
  ...
  },
  {
    ...
    needId: 'n-003',
    action: 'updated',
    description: 'Supply drop #1: 50 kits delivered to primary healthcare center',
    timestamp: new Date(Date.now() - 4 * 60 * 60 * 1000),
  },
  {
    id: 'a-027',
    needId: 'n-003',
    action: 'updated',
    description: 'Weather alert: Heavy rain may delay secondary distribution',
    timestamp: new Date(Date.now() - 2 * 60 * 60 * 1000),
  },
  {
    id: 'a-028',
    needId: 'n-004',
    action: 'created',
    description: 'Sanitation emergency in **Washim** reported by local health worker',
  ...
  },
  {
    ...
    needId: 'n-004',
    action: 'updated',
    description: 'AI detected high urgency due to "cholera risk" mention',
  ...
  },
  {
    ...
    needId: 'n-004',
    action: 'assigned',
    description: '**Aditya Bhosale** assigned for technical water survey',
    timestamp: new Date(Date.now() - 10 * 60 * 60 * 1000),
  },
  {
    id: 'a-031',
    needId: 'n-004',
    action: 'updated',
    description: 'Water purification units (12x) requested from central store',
    timestamp: new Date(Date.now() - 8 * 60 * 60 * 1000),
  },
  {
    id: 'a-032',
    needId: 'n-004',
    action: 'updated',
    description: 'Health awareness campaign launched in 3 affected villages',
  ...
  },
  {
    ...
    needId: 'n-004',
    action: 'updated',
    description: 'First batch of 5000 chlorine tablets distributed',
    timestamp: new Date(Date.now() - 2 * 60 * 60 * 1000),
  },
  {
    id: 'a-034',
    needId: 'n-100',
    action: 'created',
    description: 'Bhuj Earthquake auto-alert: 7.1 Magnitude',
  ...
  },
  {
    ...
    needId: 'n-100',
    action: 'escalated',
    description: 'Level 3 Disaster Escalation: Central relief requested',
    timestamp: new Date(Date.now() - 3 * 60 * 60 * 1000),
  },
  {
    id: 'a-036',
    needId: 'n-100',
    action: 'assigned',
    description: '**Capt. Rajesh Patel** deployed for rubble rescue operations',
  ...
  },
  {
    ...
    needId: 'n-100',
    action: 'assigned',
    description: '**Dr. Falguni Shah** assigned to triage at Bhuj Center',
  ...
  },
  {
    ...
    needId: 'n-100',
    action: 'updated',
    description: 'Satellite imagery confirmed 200+ building collapses',
  ...
  },
  {
    ...
    needId: 'n-100',
    action: 'updated',
    description: 'Mobile network restored in Bhuj West; coordination active',
    timestamp: new Date(Date.now() - 2 * 60 * 60 * 1000),
  },
  {
    id: 'a-040',
    needId: 'n-100',
    action: 'updated',
    description: 'First NDRF batch arrived at airport; moving to city center',
    timestamp: new Date(Date.now() - 1.5 * 60 * 60 * 1000),
  },
  {
    id: 'a-041',
    needId: 'n-100',
    action: 'updated',
    description: 'Night operations equipment (lighting, generators) arriving',
    timestamp: new Date(Date.now() - 1 * 60 * 60 * 1000),
  },
  {
    id: 'a-042',
    needId: 'n-100',
    action: 'updated',
    description: 'Triage update: 35 patients successfully evacuated to Rajkot',
...
export function getMatchedVolunteers(needId: string): (Volunteer & { matchScore: number })[] {
  ...
  // If we have fewer than 12 matches, fill with other available volunteers
  if (resolvedMatches.length < 12) {
    const matchedIds = new Set(resolvedMatches.map(m => m.id));
    const selectedNeed = mockNeeds.find(n => n.id === needId);
    
    const others = mockVolunteers
      .filter(v => !matchedIds.has(v.id) && (v.status === 'available' || v.status === 'deployed'))
      .map(v => {
        // Simple heuristic for score if not in match map
        let score = 60 + Math.floor(Math.random() * 20);
        if (selectedNeed) {
          const dist = Math.sqrt(Math.pow(v.lat - selectedNeed.lat, 2) + Math.pow(v.lng - selectedNeed.lng, 2));
          score = Math.max(40, Math.min(85, Math.round(90 - dist * 10)));
        }
        return { ...v, matchScore: score };
      })
      .sort((a, b) => b.matchScore - a.matchScore);
    
    return [...resolvedMatches, ...others].slice(0, 15);
  }
